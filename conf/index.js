...
const config = {
	...
	rsvp_deadline: new Date(process.env.RSVP_DEADLINE).valueOf(),
...
if (errors.length) {
	console.error('Error: Missing required configuration item(s):', errors);
	process.exit(1);
}
 ...
 * @property {Date} rsvp_deadline Date that RSVP's can be updated until.
