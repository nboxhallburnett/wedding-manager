...
`RSVP_DEADLINE` | Deadline for invited guests to RSVP. After this date only admins can update RSVPs | Timestamp, or String that is accepted by JS [`Date.parse()`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/parse) | N/A
